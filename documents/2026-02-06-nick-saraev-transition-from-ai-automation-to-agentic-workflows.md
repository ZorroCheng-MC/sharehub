---
title: "How to Transition from AI Automation to Agentic Workflows"
...
duration: 10m 27s
channel: Nick Saraev
video_date: 2026-02-05
---

# How to Transition from AI Automation to Agentic Workflows

[![Watch on YouTube](https://i.ytimg.com/vi/5rNu19PfgFg/maxresdefault.jpg)](https://www.youtube.com/watch?v=5rNu19PfgFg)
...
1. **The Hybrid Approach**: Instead of choosing between no-code platforms OR agentic workflows, combine them—use no-code for trigger/action, AI agent for complex middle logic
...
3. **Workflow Reduction**: Complex 15-20 node workflows can be reduced to 4-5 nodes by abstracting all heavy lifting to an AI agent via a simple HTTP request

4. **Real Business Impact**: Nick's example is a production system running his $2M/year dental marketing company, not a toy demo

5. **Cost Efficiency**: Modal credits are extremely cheap (~$5 lasts for thousands of requests) compared to Make/n8n subscription costs

### Actionable Points

✅ **Immediate Setup Steps**:
1. Get Modal account (modal.com) and create API token
2. Download the claw.md workspace template (linked in video)
3. Initialize AI agent with Modal credentials
4. Describe your workflow to the agent in natural language
5. Get back a ready-to-use curl command
6. Paste into n8n/Make HTTP request node
...
- **Topics**: AI, automation, agentic-workflows, development, tools, no-code
...
**Why These Tags:**
- `AI`: Core focus on AI agents handling workflow logic
- `automation`: Primary subject matter
- `agentic-workflows`: Specific methodology being taught
- `development`: Technical implementation details
- `tools`: Specific platforms discussed (n8n, Make, Modal)
- `tutorial`: Step-by-step instructional format
- `technical`: Requires understanding of HTTP requests, APIs, serverless
- `actionable`: Provides downloadable templates and immediate implementation path
...
- Find technical tutorials: `tags contains "tutorial" AND tags contains "technical"`
...
**Captured**: 2026-02-06
**Source**: https://www.youtube.com/watch?v=5rNu19PfgFg
**Channel**: Nick Saraev
