...
<svg viewBox="0 0 700 500" xmlns="http://www.w3.org/2000/svg" style="max-width: 700px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <!-- Background -->
  ...
  <rect x="80" y="40" width="540" height="380" fill="url(#grid)"/>

  <!-- Risk zones (background) -->
  <rect x="80" y="40" width="180" height="380" fill="#e8f5e9" opacity="0.5"/>
  <rect x="260" y="40" width="180" height="380" fill="#fff3e0" opacity="0.5"/>
  <rect x="440" y="40" width="180" height="380" fill="#ffebee" opacity="0.5"/>

  <!-- Axes -->
  <line x1="80" y1="420" x2="620" y2="420" stroke="#333" stroke-width="2" marker-end="url(#arrowhead)"/>
  <line x1="80" y1="420" x2="80" y2="40" stroke="#333" stroke-width="2" marker-end="url(#arrowhead)"/>
  ...
  <!-- Axis labels -->
  <text x="350" y="465" text-anchor="middle" font-size="14" font-weight="bold" fill="#333">RISK LEVEL →</text>
  <text x="25" y="230" text-anchor="middle" font-size="14" font-weight="bold" fill="#333" transform="rotate(-90, 25, 230)">RETURN POTENTIAL →</text>

  <!-- Risk level labels -->
  <text x="170" y="445" text-anchor="middle" font-size="11" fill="#4caf50">LOW</text>
  <text x="350" y="445" text-anchor="middle" font-size="11" fill="#ff9800">MEDIUM</text>
  <text x="530" y="445" text-anchor="middle" font-size="11" fill="#f44336">HIGH</text>

  <!-- Stock bubbles -->
  <!-- PH - LOW risk, lowest return -->
  <circle cx="150" cy="360" r="28" fill="#4caf50" opacity="0.8"/>
  <text x="150" y="355" text-anchor="middle" font-size="11" font-weight="bold" fill="white">PH</text>
  <text x="150" y="370" text-anchor="middle" font-size="9" fill="white">10%</text>

  <!-- RTX - LOW risk, low-mid return -->
  <circle cx="170" cy="310" r="30" fill="#4caf50" opacity="0.8"/>
  <text x="170" y="305" text-anchor="middle" font-size="11" font-weight="bold" fill="white">RTX</text>
  <text x="170" y="320" text-anchor="middle" font-size="9" fill="white">12%</text>

  <!-- LHX - LOW-MED risk, low-mid return -->
  <circle cx="240" cy="295" r="28" fill="#8bc34a" opacity="0.8"/>
  <text x="240" y="290" text-anchor="middle" font-size="11" font-weight="bold" fill="white">LHX</text>
  <text x="240" y="305" text-anchor="middle" font-size="9" fill="white">10%</text>

  <!-- GOOGL - LOW risk, mid return -->
  <circle cx="140" cy="240" r="34" fill="#4caf50" opacity="0.8"/>
  <text x="140" y="235" text-anchor="middle" font-size="11" font-weight="bold" fill="white">GOOGL</text>
  <text x="140" y="250" text-anchor="middle" font-size="9" fill="white">15%</text>

  <!-- ATI - MEDIUM risk, low-mid return -->
  <circle cx="320" cy="320" r="22" fill="#ff9800" opacity="0.8"/>
  <text x="320" y="315" text-anchor="middle" font-size="11" font-weight="bold" fill="white">ATI</text>
  <text x="320" y="330" text-anchor="middle" font-size="9" fill="white">6%</text>

  <!-- CRS - MEDIUM risk, mid-high return -->
  <circle cx="340" cy="200" r="30" fill="#ff9800" opacity="0.8"/>
  <text x="340" y="195" text-anchor="middle" font-size="11" font-weight="bold" fill="white">CRS</text>
  <text x="340" y="210" text-anchor="middle" font-size="9" fill="white">12%</text>

  <!-- LITE - MED-HIGH risk, mid-high return -->
  <circle cx="420" cy="215" r="20" fill="#ff5722" opacity="0.8"/>
  <text x="420" y="210" text-anchor="middle" font-size="10" font-weight="bold" fill="white">LITE</text>
  <text x="420" y="225" text-anchor="middle" font-size="8" fill="white">5%</text>

  <!-- SMT - HIGH risk, high return -->
  <circle cx="500" cy="120" r="28" fill="#f44336" opacity="0.8"/>
  <text x="500" y="115" text-anchor="middle" font-size="11" font-weight="bold" fill="white">SMT</text>
  <text x="500" y="130" text-anchor="middle" font-size="9" fill="white">10%</text>

  <!-- RKLB - HIGH risk, high return -->
  <circle cx="520" cy="160" r="30" fill="#f44336" opacity="0.8"/>
  <text x="520" y="155" text-anchor="middle" font-size="11" font-weight="bold" fill="white">RKLB</text>
  <text x="520" y="170" text-anchor="middle" font-size="9" fill="white">12%</text>

  <!-- ASTS - VERY HIGH risk, highest return -->
  <circle cx="580" cy="75" r="25" fill="#b71c1c" opacity="0.9"/>
  <text x="580" y="70" text-anchor="middle" font-size="11" font-weight="bold" fill="white">ASTS</text>
  <text x="580" y="85" text-anchor="middle" font-size="9" fill="white">8%</text>

  <!-- Legend -->
  <rect x="80" y="480" width="540" height="2" fill="#ccc"/>
  <text x="100" y="495" font-size="10" fill="#666">Bubble size = portfolio allocation | Color = risk level (green=low, orange=medium, red=high)</text>
</svg>
